...
# # def validate_binary_schema(schema_path: str) -> Dict[str, Any]:
# #     """Validate and load new binary schema format"""
...
# def cli():
#     """Telemetry Generator - High-performance telemetry data generator with binary schema support"""
#     pass
...
#               default='binary',  # Changed default to binary for new format
...
#     """Generate telemetry data with binary schema format"""
...
#                     )
#                     logger.debug(
#                         f"Rate: target={rate:,}, actual={actual_rate:.1f}, smoothed={rate_limiter.get_smoothed_rate():.1f} rec/s"
#                     )
#                     logger.debug(
...
# def validate(schema,types,records, show_sample, check_size):
#     """Validate binary schema and generate test records"""
